...
@section('content')
<div ng-controller="vendorCtrl" ng-init="getAllCategories(); getVendorInfo({{$id}})">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-vcard"></i> Edit Vendor</h1>
    </div>
  ...
  <div class="card shadow" style="padding: 15px">
    ...
    <hr>
    <div class="tile-body">
      <form ng-submit="updateVendor(vendor)">
        <div class="row">
          <div class="col-md-3">
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input class="form-control" ng-disabled="true" ng-model="vendor.email" type="text" placeholder="Enter Email Address">
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input class="form-control" ng-model="vendor.service_start_time" type="text" placeholder="Enter Service Start Time">
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input class="form-control" ng-model="vendor.service_end_time" type="text" placeholder="Enter Service End Time">
            </div>
          </div>
        </div>
